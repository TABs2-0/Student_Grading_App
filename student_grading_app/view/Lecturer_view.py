...
class LecturerLogin(tk.Tk):
    ...
    def setup_ui(self):
        ...
        self.course_title_label = tk.Label(self.course_frame, text="Course List", font=("Arial", 12, "bold"),
                                           bg="#ADD8E6")
        ...
        self.add_entry.pack()
        self.upload_button = tk.Button(self.course_frame, text="Upload", width=10, command=self.select_file)
